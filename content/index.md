...
<div class="hero-section animate-fade-in">
  ...
  <p class="hero-tagline">
    ...
    I've <a href="javascript:void(0)" onclick="document.querySelector('.lang-content.active #ai-vibe-coding')?.scrollIntoView({behavior:'smooth'})">built 3 products as a solo full-stack developer</a> through vibe coding, while designing and building the backend for a RAG-based AICC solution.<br><br>
...
<div class="hero-section animate-fade-in">
  ...
  <p class="hero-tagline">
    ...
    바이브코딩으로 <a href="javascript:void(0)" onclick="document.querySelector('.lang-content.active #ai-vibe-coding')?.scrollIntoView({behavior:'smooth'})">3개 프로덕트를 1인 풀스택 개발</a>하고, RAG 기반 AICC 솔루션의 백엔드를 설계·구현하고 있습니다.<br><br>
